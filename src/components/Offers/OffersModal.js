      ...
      {backShow && offer1 && (
        <div className={classes.body}>
          ...
          <ol className={classes.ol}>
            <li>
              ...
              <Typography className={classes.termsBody}>
                ...
                July 01, 2024 to March 31, 2024. Please check the product page
          ...
          <ol className={classes.ol}>
            ...
            <li>
              <Typography className={classes.termsBody}>
                The Offer is valid from July 01, 2024 to March 31, 2024 i.e.
      ...
      {backShow && offer2 && (
        <div className={classes.body}>
          ...
          <ol className={classes.ol}>
            ...
            <li>
              <Typography className={classes.termsBody}>
                The offer is valid in the month of September 2024 i.e. 2nd to
                5th September 2024 ("<b>Offer Period</b>"), unless revoked or
                extended by Amazon in its sole discretion, without any prior
